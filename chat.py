"""Simple RAG chat runner using Google GenAI embeddings and Qdrant vector store.

This module loads environment configuration, queries a Qdrant vector
collection for relevant context, and calls a Google Generative AI chat model
to answer the user's query based on retrieved documents.
"""
